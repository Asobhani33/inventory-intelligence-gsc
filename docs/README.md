...
| Demand forecast accuracy | WAPE 39.9% (see "Honest limitations" — this is reported, not smoothed over) |
...
- **Forecast accuracy (WAPE 39.9%)** is reported as-is. The demand series
  ...
  to 39.9% without adding any new features.)
